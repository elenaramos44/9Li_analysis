...
#SBATCH --mem=16G
#SBATCH --time=4:00:00
#SBATCH --array=0-92    #python3 /scratch/elena/9Li/scripts/get_chunks.py /data/elena/data/WCTE_offline_R{RUN}S0_VME_matched.root
...
BASE_PATH=/data/elena/data/p_260
